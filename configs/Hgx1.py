...
SENSOR_MONITOR_CONFIG = [
	['/org/openbmc/sensors/temperature/TMP1', { 'object_path' : '/sys/class/hwmon/hwmon1/tmp1_input','poll_interval' : 5000,'scale' : 1,'units' : 'C'}],
	['/org/openbmc/sensors/temperature/TMP2', { 'object_path' : '/sys/class/hwmon/hwmon1/tmp2_input','poll_interval' : 5000,'scale' : 1,'units' : 'C'}],
	['/org/openbmc/sensors/temperature/TMP3', { 'object_path' : '/sys/class/hwmon/hwmon1/tmp3_input','poll_interval' : 5000,'scale' : 1,'units' : 'C'}],
